...
_SKEY_REFRESH_SAFE_DUR = 60 * 5  # Minimum remaining SSO session duration required for refresh.
...
def maybe_refresh_credential(profile):
    ...
    try:
        ...
        if sso_remaining < _SKEY_REFRESH_SAFE_DUR:
            # The SSO session cannot issue a credential with the minimum duration; re-login is required.
            return

...
INFO = {
  "ListTopData": {
    "params": [
      {
        "name": "StartTime",
        "desc": "Starting time of the queried period, such as `2018-09-09 00:00:00`. Currently, only 1-day granularity is supported, so only the date information will be used for the query."
      },
      {
        "name": "EndTime",
        "desc": "End time of the queried period, such as `2018-09-10 00:00:00`. Currently, only 1-day granularity is supported, so only the date information will be used for the query. For example, to query data on September 10, 2018, just enter `StartTime=2018-09-10 00:00:00` and `EndTime=2018-09-10 00:00:00`."
      },
      {
        "name": "Metric",
  ...
  "GetDisableRecords": {
    ...
    "desc": "This API (GetDisableRecords) is used to query the resource blocking history and the current URL status. (This API is during beta test and not fully available now.)"
  },
  "DescribePayType": {
    "params": [
      {

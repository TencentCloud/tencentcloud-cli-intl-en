...
def doQueryVideoFaceFusionJob(args, parsed_globals):
    ...
    model = models.QueryVideoFaceFusionJobRequest()
    model.from_json_string(json.dumps(args))
    start_time = time.time()
    while True:
        rsp = client.QueryVideoFaceFusionJob(model)
...
ACTION_MAP = {
    "QueryVideoFaceFusionJob": doQueryVideoFaceFusionJob,
